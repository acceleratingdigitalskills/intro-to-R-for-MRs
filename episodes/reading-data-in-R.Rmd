...
More often than not, our data will contain some missing values, perhaps because certain participants did not complete the survey, or naybe there were some optional questions which participants opted to skip. 
...
The `na.strings` argument allows you to specify which values in your data set should be interpreted as NA values. T
...
``` R
exceldata <- read_excel("dummay_data.xlsx", na = "N/A")
```
